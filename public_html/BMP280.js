...
export default class BMP280{
  ...
  readPressure() {
    ...
    var2 = var2 + (var1 * this._bmp280_calib.dig_P5) * pow2(17);
    var2 = var2 + this._bmp280_calib.dig_P4 * pow2(35);
    var1 = (var1 * var1 * this._bmp280_calib.dig_P3) * pow2(8) + (var1 * this._bmp280_calib.dig_P2) * pow2(12);
    var1 = (pow2(47) + var1) * this._bmp280_calib.dig_P1 * pow2(33);
    ...
    var1 = Math.floor((this._bmp280_calib.dig_P9) * Math.floor(p / pow2(13)) * Math.floor(p / pow2(13))) / pow2(25);
    var2 = Math.floor((this._bmp280_calib.dig_P8 * p) / pow2(19));
  
    p = Math.floor((p + var1 + var2) / pow2(8)) + this._bmp280_calib.dig_P7 * pow2(4);
    return p / 256.0;
  }
